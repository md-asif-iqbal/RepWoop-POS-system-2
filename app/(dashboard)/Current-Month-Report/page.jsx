...
const filterByMonth = (data, dateField) => {
  ...
  return data.filter((item) => {
    ...
    return (
      isSameYear(itemDate, currentDate) && isSameMonth(itemDate, currentDate)
    );
  });
};
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredSales = filterByMonth(salesData, "sale_date");
        const filteredExpenses = filterByMonth(expensesData, "created_at");
        const filteredSuppliers = filterByMonth(suppliersData, "created_at");
        const filteredCustomers = filterByMonth(customersData, "createdat");
        ...
        alert("Failed to fetch current month's data.");
      } finally {
        setLoading(false);
      }
    };
